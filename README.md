...
```lua
{
    ...
    [[<cmd>lua require("tmux").move_to(direction)<cr>]], -- direction is "h", "j", "k", "l".
...
```lua
{
    ...
    [[<cmd>lua require("tmux").resize_to(direction, step)<cr>]], -- direction is "h", "j", "k", "l".
}
```
...
```lua
{
    ...
    [[<cmd>lua require("tmux").swap_to(direction)<cr>]], -- direction is "h", "j", "k", "l".
}
```
